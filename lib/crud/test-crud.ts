...
const testEditFields: EditFieldConfig<ClientData>[] = [
  createEditFieldConfig(
    ...
    "input",
    true,
    persianValidationRules.persianName,
  ),
  createEditFieldConfig(
    "phone",
    "شماره تماس",
    "input",
    true,
    persianValidationRules.persianPhone,
  ),
  createEditFieldConfig(
    "ssn",
    "کد ملی",
    "input",
    true,
    persianValidationRules.persianSSN,
  ),
  createEditFieldConfig(
    "address",
    "آدرس",
    "textarea",
    true,
    persianValidationRules.persianText,
  ),
  createEditFieldConfig(
    "postal_code",
    "کد پستی",
    "input",
    true,
    persianValidationRules.persianPostalCode,
  ),
];

// Test creating validation rules
const testValidationRules: ValidationConfig<ClientData> =
  createValidationRules<ClientData>();
